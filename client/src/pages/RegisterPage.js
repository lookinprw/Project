  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-white to-indigo-50 flex flex-col justify-center py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-4 sm:mt-6 text-center text-xl sm:text-3xl font-extrabold text-gray-900">
          ลงทะเบียนใช้งานระบบ
        </h2>
      </div>
        ...
        <div className="bg-white py-6 sm:py-8 px-4 shadow-xl sm:shadow-2xl sm:rounded-lg sm:px-10 border border-gray-100">
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  } rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors duration-200 text-xs sm:text-sm`}
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="block w-full pl-9 sm:pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors duration-200 text-xs sm:text-sm"
                >
                  <option value="ITD">
          ...
          <div className="mt-4 sm:mt-6">
            ...
            <div className="mt-4 sm:mt-6">
              <Link
                to="/login"
                className="w-full flex justify-center py-2 sm:py-2.5 px-4 border border-gray-300 rounded-lg shadow-sm text-xs sm:text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200"
              >
                เข้าสู่ระบบ
              </Link>
            </div>
